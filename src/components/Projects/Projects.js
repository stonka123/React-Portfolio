		...
		<section className={`${styles.projects} wrapper`} id='projects'>
			...
			<div className={styles['projects-container']}>
				<div className={styles.top}>
					<h3>Projects</h3>
					<p>
						Lorem, ipsum dolor sit amet consectetur adipisicing elit. Qui distinctio ut eveniet reiciendis earum ad quo
						delectus maiores consequatur, assumenda cupiditate praesentium dolore dolores nesciunt, repudiandae alias et
